...
All notable changes to the LLM SDK will be documented in this file.

## [0.3.3] - 2025-11-02
- **Models ** : Added GPT5 series
  - Added New OpenAI pricing
  - Cleaned up verbose docs. I mean what is the point in so much lol.
  - Fixed multiple OpenAI Agent specific adapter issues
    - Primarily due to async
    - Adding streams into existing archetecture
    - Handling issues where no tools initialised
